...
lesson_ls = {
    ...
    "5":{
        "id": 5,
        "Title": "Overall Goal",
        "Subtitle1": "You want to claim all of the card.",
    ...
    "7":{
        ...
        "Example":"One player plays a 6 and the next player also plays a 6.",
        "Category":"Rules",
        "Status":"2 of 18",
        "Time": None,
    },
    "8":{
        ...
        "Example":"One player plays a 7, the next player plays a 4, and the following player plays a 7.",
        "Category":"Rules",
        "Status":"3 of 18",
        "Time": None,
    },
    "9":{
        ...
        "Example":"One player plays a Queen and the next player plays a King.",
        "Category":"Rules",
        "Status":"4 of 18",
        "Time": None,
    },
    "10":{
        ...
        "Example":"One player plays a 3 and the next player plays a 7.",
        "Category":"Rules",
        "Status":"5 of 18",
        "Time": None,
    },
    "11":{
        ...
        "Example":"There is a double 7 in the pile, but the following player plays a 2 before anybody can slap.",
        "Category":"Rules",
        "Status":"6 of 18",
        "Time": None,
    },
    "12":{
        ...
        "Example":"A player slaps the pile with an 8 and a 3 at the top.",
        "Category":"Rules",
        "Status":"7 of 18",
        "Time": None,
    },
    ...
    "16":{
        ...
        "Title": "Face Cards and Aces:",
        "Title2": "Jacks",
        "Subtitle1":"When a Jack is played, the next player gets 1 turn to play another face card or ace.", 
    ...
    "17":{
        ...
        "Title": "Face Cards and Aces:",
        "Title2": "Queens",
        "Subtitle1":"When a Queen is played, the next player gets 2 turns to play another face card or ace.",
    ...
    "18":{
        ...
        "Title": "Face Cards and Aces:",
        "Title2": "Kings",
        "Subtitle1":"When a King is played, the next player gets 3 turns to play another face card or ace",
    ...
    "19":{
        ...
        "Title": "Face Cards and Aces:",
        "Title2": "Aces",
        "Subtitle1":"When an Ace is played, the next player gets 4 turns to play another face card or ace.",
